...
CREATE TABLE IF NOT EXISTS `satod`.`columnasCartera` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_columnasCartera_carteras1_idx` (`carteras_id` ASC),
  CONSTRAINT `fk_columnasCartera_carteras1`
...
-- -----------------------------------------------------
-- Table `satod`.`indicadores_has_carteras`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `satod`.`indicadores_has_carteras` ;

CREATE TABLE IF NOT EXISTS `satod`.`indicadores_has_carteras` (
  `indicadores_id` INT UNSIGNED NOT NULL,
  `carteras_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`indicadores_id`, `carteras_id`),
...
-- -----------------------------------------------------
-- Table `satod`.`costos_has_estrategias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `satod`.`costos_has_estrategias` ;

CREATE TABLE IF NOT EXISTS `satod`.`costos_has_estrategias` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE INDEX `costos_id_UNIQUE` (`costos_id` ASC),
  UNIQUE INDEX `estrategias_id_UNIQUE` (`estrategias_id` ASC),
...
CREATE TABLE IF NOT EXISTS `satod`.`filasCartera` (
  ...
  `carteras_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_filasCartera_carteras1_idx` (`carteras_id` ASC),
  CONSTRAINT `fk_filasCartera_carteras1`
    FOREIGN KEY (`carteras_id`)
    REFERENCES `satod`.`carteras` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
