<?php 
$data = $this->Js->get('#PagoGenerarScoringDeudoresForm')->serializeForm(array('isForm' => true, 'inline' => true));
$this->Js->get('#PagoGenerarScoringDeudoresForm')->event(
      'submit',
      sprintf("
            $(function(){
...
//                                $(location).attr('href', 'generarScoringDeudores/' + $(\"#cartera_seleccionada\").val() + '.pdf');
//                                        },
                                        Cerrar: function() {
                                            $(this).dialog(\"close\");
                                        },
...
<div spellcheck="<none>" class="pagos form">
    <?php echo $this->Form->create('Pago', array('action' => 'generarScoringDeudores', 'default' => false)); ?>
    <fieldset spellcheck="true" >
        <legend><?php echo 'Generar Scoring de Deudores'; ?></legend>
        <?php
