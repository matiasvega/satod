...
<!--		<td><?php // echo h($group['Group']['created']); ?>&nbsp;</td>
		...
		<td class="actions">
			<?php // echo $this->Html->link(__('View'), array('action' => 'view', $group['Group']['id'])); ?>
                    ...
                    <?php echo $this->Form->postLink($this->Html->image('eliminar.png', array('alt' => 'Eliminar', 'title' => 'Eliminar')), array('action' => 'delete', $group['Group']['id']), array('escape' => false), __('Confirma que desea eliminar los datos del grupo %s?', $group['Group']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
